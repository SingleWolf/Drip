...
public class MainTabPreferenceFragment extends AbstractBaseActivityFragment {
    public static final String TAG = "MainTabPreferenceFragment";
    /**
     * 获取Fragment实例
     *
     * @return Fragment
    ...
    public static Fragment getInstance() {
        return new MainTabPreferenceFragment();
    }
    ...
    protected int getLayoutId() {
        return R.layout.app_fragment_main_preference;
    }
